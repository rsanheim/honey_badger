...
Gem::Specification.new do |s|
  ...
  s.description = "Get a nice, clean badge displaying your Rails
                   Environment or other helpful info. Want to display last
                   deploy date? Or maybe the status of some app wide
                   settings? Throw it in HoneyBadger! He just doesn't care!"
  s.files       = Dir["app/**/*"] + Dir["lib/**/*"] + ["MIT-LICENSE", "Rakefile", "README.markdown"]
  s.license     = 'mit'
end
